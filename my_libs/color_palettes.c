...
// 3 - Rainbow colors with alternating stripes of black
...
// 4 - Blue purple ping red orange yellow (and back)
...
// 5 - Approximate "black body radiation" palette, akin to
